...
public class AlarmBroadcast extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        int notificationId = bundle.getInt("notificationId", 0); // Get notification ID from intent
        ...
        PendingIntent pendingIntent = PendingIntent.getActivity(context, notificationId, intent1, PendingIntent.FLAG_ONE_SHOT | PendingIntent.FLAG_MUTABLE);
        ...
        notificationManager.notify(notificationId, notification); // Use notification ID
